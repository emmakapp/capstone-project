    ...
    return  (
        <div id="confirmationwrapper">
            <h2 style={{ paddingBottom: "20px"}}>Confirmation Page</h2>
                ...
                <p style={{ paddingBottom: "20px"}}> Please confirm your details by clicking Login below, 
                where you can continue your registration as a guest or as a registered user.</p>
            <div>
                <p> Date: {" "} {JSON.parse(localStorage.getItem("formData")).date}</p>
